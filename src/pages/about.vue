    ...
    children: [
      {
        label: 'Author',
        icon: 'face',
        children: [{ label: 'leovoon' }],
      },
      {
        label: 'Technology',
        icon: 'construction',
        children: [{ label: 'Vite' }, { label: 'Vue, Pinia' }, { label: 'Quasar' }],
      },
      {
        label: 'Copyright',
        icon: 'copyright',
        children: [{ label: 'MIT License' }],
      },
      {
        label: 'Github',
        icon: 'code',
        children: [{ label: 'https://github.com/leovoon/vue-budget-app' }],
      },
    ],
  },
])
